# =========================================================
# Nexus RangeMaster v1 — Ultimate Ranging Market Trading Engine
# XT + Gate.io | RSI/BB Mean-Reversion | ADX Range Filter | ML Confidence | Backtest Mode
# =========================================================
...
# Page config
# ---------------------------------------------------------
st.set_page_config(page_title="Nexus RangeMaster v1", page_icon="📊", layout="wide")
st.title("📊 Nexus RangeMaster v1 — Ultimate Ranging Market Trading Engine")
...
# ---------------------------------------------------------
# Ranging Indicators: RSI, Bollinger Bands, ADX
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# Ranging Signal Engine with ML Confidence
# ---------------------------------------------------------
ml_model = None
ml_scaler = None
...
def generate_and_log_signal(asset, tf, df, force_log=False):
    ...
    record = {
        ...
        "model_hash": hashlib.md5(b"RangeMasterV1").hexdigest(),
        "status": "OPEN",
        "features": features
    }
