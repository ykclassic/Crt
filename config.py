...
# --- ASSET SETTINGS ---
ASSETS = ["BTC/USDT", "ETH/USDT", "SOL/USDT", "BNB/USDT", "DOGE/USDT", "XRP/USDT", "ADA/USDT", "PEPE/USDT", "SUI/USDT", "LTC/USDT"]
...
# THESE ARE THE MISSING VARIABLES CAUSING THE TRACEBACK
